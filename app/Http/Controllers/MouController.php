...
class MouController extends Controller {
    ...
    if($check) {
      if($route == '/mou/upload') {
        return view('/mou/uploadMoU');
      }
      else {
        $dataMoU = $this->joinTable(); //CALL FUNCTION JOIN TABLE TO VARIABLE
        return view('/mou/arsipMoU', compact('dataMoU'));
      }
    }
    else {
      return view('login');
  ...
  public function editMoU($id) {
    ...
    if($check) {
      ...
      return view('/mou/editMoU', compact('dataMoU'));
    }
    else {
      return view('login');
    }
  ...
  public function update(Request $request, $id)  {
    ...
    if ($updateValidator->fails()) {
      ...
      return view('/mou/arsip'); //REDIRECT BACK TO KELOLAMOU PAGE
    }
    ...
    return redirect('/mou/arsip'); //REDIRECT BACK TO MOU PAGE
  }
