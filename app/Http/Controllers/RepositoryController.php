...
class RepositoryController extends Controller
{
  ...
  public function searchPublikasiRepo(Request $request) {
    //CHECK IF USER IS LOGGED IN OR NOT
    $SSOController = new SSOController(); //INISIALISASI CLASS SSOCONTROLLER
    $check = $SSOController->loggedIn(); //SIMPAN NILAI FUNCTION LOGGEDIN(); 
    ...
    if ($check) {
      ...
      $kategori = "publikasi";
      return view('/searchRepo', compact('dataBuku', 'dataArtikelIlmiah', 'dataArtikelPopuler', 'kategori'));
    }
  }

  public function searchKegiatanRepo(Request $request) {
    //CHECK IF USER IS LOGGED IN OR NOT
    $SSOController = new SSOController(); //INISIALISASI CLASS SSOCONTROLLER
    $check = $SSOController->loggedIn(); //SIMPAN NILAI FUNCTION LOGGEDIN(); 
    ...
    if ($check) {
      ...
      $kategori = "kegiatan";
      return view('/searchRepo', compact('dataPenelitian', 'dataPengmas', 'dataKegiatanIlmiah', 'kategori'));
    }
  } 
}
