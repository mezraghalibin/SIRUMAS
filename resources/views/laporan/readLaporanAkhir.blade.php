          ...
          <table class="highlight centered">
            <thead>
              <tr>
                ...
                <th data-field="id">Referensi Laporan Kemajuan</th>
                <th data-field="id">Judul Laporan Akhir</th>
            ...
            <tbody>
              ...
              <tr>
                <td>{{$akhir->judul}}</td>
                <td>{{$akhir->judul_laporan_kemajuan}}</td>
                <td>{{$akhir->judul_laporan_akhir}}</td>
