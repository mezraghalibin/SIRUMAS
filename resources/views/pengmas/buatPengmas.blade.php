...
<body>
  ...
  <div class="page-content">
    ...
    {{-- CONTENT BUAT PENGMAS --}}
    <div id="buat-pengmas-konten">
      <div class="container">
        <div class="header"><h4>Buat Pengabdian Masyarakat</h4></div>
        <div class="hibah-riset-content">
          <div class="row">
            <form class="col s12" method="post" action="/kelolaRepository/pengmas/buat" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="input-field col s8 offset-s2">
                  <input placeholder="Nama kegiatan" name="nama_kegiatan" type="text" class="validate" required>
              ...
              <div class="row">
                <div class="input-field col s8 offset-s2">
                  <input placeholder="Penyelenggara" name="penyelenggara" type="text" class="validate" required>
              ...
              <div class="row">
                <div class="input-field col s5 offset-s2">
                  <input placeholder="Peranan" name="peranan" type="text" class="validate" required>
                  <label for="judulproposal">Peranan</label>
                </div>
                <div class="input-field col s3">
                  <input placeholder="Masukan Angka Saja" name="nominal" type="number" class="validate" required>
              ...
              <div class="row">
                <div class="input-field col s8 offset-s2">
                  <input placeholder="Ketua tim" name="ketua" type="text" class="validate" required>
              ...
              <div class="row">
                <div class="input-field col s8 offset-s2">
                  <input placeholder="Anggota A;Anggota B;Anggota C;dst.." name="nama_anggota" 
              ...
              <div class="row">
                ...
                <div class="input-field col s3">
                  <input type="date" name="waktu" class="datepicker" required>
              ...
              <div class="row">
                <div class="file-field input-field col s8 offset-s2">
                  <div class="btn">
                    ...
                    <input name="bukti" type="file" placeholder="Masukkan bukti kontrak pengmas" required>
                  </div>
