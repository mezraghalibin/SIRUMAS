  ...
  <title>KELOLA ARTIKEL ILMIAH</title>
    ...
    $(document).ready(function(){
      $role = "<?php echo $spesifik_role ?>";
        ...
        $("#buat-artikel-ilmiah-konten").hide();

        $("#kelola-artikel-ilmiah").click(function(){
            $("#kelola-artikel-ilmiah-konten").fadeIn(500);
            $("#buat-artikel-ilmiah-konten").hide();
        });

         $("#buat-artikel-ilmiah").click(function(){
            $("#buat-artikel-ilmiah-konten").fadeIn(500);
            $("#kelola-artikel-ilmiah-konten").hide();
        });
  ...
  <div class="page-content">
    ...
    <nav class="second-navbar">
      <div class="nav-wrapper">
        <ul class="left hide-on-med-and-down">
          <li id="kelola-artikel-ilmiah"><a href="#">Kelola Artikel Ilmiah</a></li>
          <li id="buat-artikel-ilmiah"><a href="#">Buat Artikel Ilmiah</a></li>     
        </ul>
    ...
    <div class="container">
      <div id="kelola-artikel-ilmiah-konten">
        <div class="header"><h4>Kelola Artikel Ilmiah</h4></div>
