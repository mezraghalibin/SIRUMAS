...
@section('main_content')
  ...
  <div class="page-content">
    ...
    <nav class="second-navbar">
      <div class="nav-wrapper">
        <ul class="left hide-on-med-and-down">
          <li id="kelola-buku"><a href="/kelolaRepository/artikelPopuler/kelola">Kembali</a></li> 
        </ul>
    ...
    {{-- CONTENT EDIT BUKU --}}
    <div id="edit-artikel-populer-konten">
      <div class="container">
        <div class="header"><h4>Edit {{$artikelPopuler->judul}}</h4></div>
        <div class="artikel-populer-content">
          <div class="row">
            <form method="POST" action="/kelolaRepository/artikelPopuler/update/{{ $artikelPopuler->id }}" 
              ...
              <div class="row">
                <div class="input-field col s6 offset-s3">
                  <input placeholder="Judul Artikel Populer" id="judul" name="judul" type="text" 
                    class="validate" value="{{ $artikelPopuler->judul }}" required>
              ...
              <div class="row">
                <div class="input-field col s6 offset-s3">
                <input placeholder="Dimuat Pada" id="dimuat_di" name="dimuat_di" type="text" 
                  class="validate" value="{{ $artikelPopuler->dimuat_di }}" required>
              ...
              <div class="row">
                <div class="input-field col s6 offset-s3">
                  <input placeholder="Penulis" name="penulis_utama" id="penulis" type="text" 
                    class="validate" value="{{ $artikelPopuler->penulis_utama }}" required>
              ...
              <div class="row">
                ...
                <?php 
                  $all_anggota_penulis = $artikelPopuler::find($artikelPopuler->id)->getAnggota;
                  $list = "";
              ...
              <div class="row">
                <div class="input-field col s3 offset-s3">
                  <input placeholder="Nomor" name="no" id="no" type="text" 
                    class="validate" value="{{ $artikelPopuler->no }}" required>
                  <label for="no">No. </label>
                </div>
                <div class="input-field col s2">
                  <input placeholder="Jumlah Halaman" name="halaman" id="halaman" type="text" 
                    class="validate"  value="{{ $artikelPopuler->halaman }}" required>
                  <label for="Halaman">Jumlah Halaman</label>
                </div>
                <div class="input-field col s1">
                  <input placeholder="Tahun" name="tahun" id="tahun" type="text" 
                    class="validate" value="{{ $artikelPopuler->tahun }}" required>
              ...
              <div class="row">
                <div class="input-field col s3 offset-s3">
                  <input placeholder="Penerbit" name="penerbit" id="penerbit" type="text" 
                    class="validate" value="{{ $artikelPopuler->penerbit }}" required>
                  <label for="penerbit">Penerbit</label>
                </div>
                <div class="input-field col s3">
                  <input placeholder="URL" name="url" id="url" type="text" 
                    class="validate" value="{{ $artikelPopuler->url }}" required>
