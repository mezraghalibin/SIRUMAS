      ...
      <div class="row">      
        ...
        <hr>
          @if (count($borangs))
            ...
            @endforeach
          @endif
              <button class="btn waves-effect waves-light card-panel red darken-2" type="submit" name="action" value="post"><span class="white-text">Simpan</span><i class="material-icons right">send</i></button>
