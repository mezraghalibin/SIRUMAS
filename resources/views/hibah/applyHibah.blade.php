    ...
    <div class="container">
      <div id="apply-hibah">
        <div class="apply-content">
          <div class="row">
            <form class="col s12" method="post" action="/proposal/applyHibah" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="input-field col s6 offset-s1">
                  <input placeholder="Nama Anda" id="nama" name="nama_pengaju" 
                    type="text" class="validate" required>
                  <label for="nama">Nama</label>
                </div>
                <div class="input-field col s4">
                  <input placeholder="Masukan NIP/NUP Anda" id="nip/nup" name="nip/nup" 
                    type="text" class="validate" required>
              ...
              <div class="row">
                <div class="input-field col s6 offset-s1">
                  <input placeholder="Judul proposal yang diajukan" name="judul_proposal" 
                    id="judulproposal" type="text" class="validate" required>
                  <label for="judulproposal">Judul Proposal</label>
                </div>
                <div class="input-field col s4">
                  <input placeholder="Nomor HP Anda" name="no_hp" id="nohp" 
                    type="text" class="validate" required>
              ...
              <div class="row">
                ...
                <div class="input-field col s4">
                  <input placeholder="Email Anda" name="e-mail" id="email" type="email" class="validate" required>
