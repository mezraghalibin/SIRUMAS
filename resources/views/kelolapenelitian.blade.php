    ...
    <nav class="second-navbar">
      <div class="nav-wrapper">
        <ul class="left hide-on-med-and-down">
          <li id="kelola-penelitian"><a href="#">Kelola Penelitian</a></li>
          <li id="buat-penelitian"><a href="#">Buat Penelitian</a></li>     
        </ul>
        ...
        <div class="kelola-content">
          <table class="highlight centered">
            <thead> {{-- NAMA JUDUL DARI KELOLA HIBAH --}}
              <tr>
                  <th data-field="nama_hibah" style="width:30%">Judul Penelitian</th>
                  <th data-field="kategori_hibah">Ketua Peneliti</th>
                  <th data-field="besar_dana">Sumber Dana</th>
                  <th data-field="periode">Besar Dana</th>
            ...
            <tbody>  {{-- ISI DARI TIAP HIBAH --}}
                  <tr>
                    <td>Penelitian Propensi</td>
                    <td>Bambang Sutedja</td>
                    <td>Universitas Indonesia</td>
                    <td>Rp 20.0000.000,00</td>
