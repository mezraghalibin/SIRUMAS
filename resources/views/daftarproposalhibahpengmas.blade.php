...
<body>
  ...
  <div class="page-content">
    ...
    <nav class="second-navbar">
      <div class="nav-wrapper">
        <ul class="left hide-on-med-and-down">
            <li id="navbar-hibah-riset"><a href="/proposalpengmas">Kembali
            </a></li>
        </ul>
    ...
    {{-- LIST OF PROPOSAL HIBAH PENGMAS --}}
    <div class="container">    
              ...
              @foreach ($allDataForKeuangan as $proposal)
                <tr>
                  ...
                  <td>
                    ...
                    <a href='/daftarproposalhibahpengmas/nilaiproposalpengmas/{{$proposal->id_proposal}}'>
                  ...
                  <td>
                    @if($proposal->komentar == null)
                      <a href='/daftarproposalhibahpengmas/sesuaikanproposalpengmas/{{$proposal->id_proposal}}'>
    ...
    {{-- END OF LIST OF PROPOSAL HIBAH PENGMAS --}}
  </div>
  {{-- PAGE CONTENT --}}
  @stop
</body>
