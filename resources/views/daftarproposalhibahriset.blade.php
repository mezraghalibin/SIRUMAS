          ...
          <div class="hibah-riset-content">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                <a href='nilaiproposalriset/{{$proposal->id}}'><button class="btn waves-effect waves-teal card-panel red darken-2"><span class="white-text">Nilai</span></button></a>
                </td>
                <td><a href='sesuaikanproposalriset/{{$proposal->id}}'><button class="btn waves-effect waves-teal card-panel red darken-2"><span class="white-text">Sesuaikan</span></button></a></td>
                <td><select name="status" value="" class="browser-default validate" style="width:100px">
